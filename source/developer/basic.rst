...
With the last command you installed the first Hands-On (option *-D*) using a *bash* profile (option *-P*). The profile represents the programming language used to implements the Hands-On run executables.  
