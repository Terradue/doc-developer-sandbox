...
The job template sets the :doc:`ciop.job.max.tasks </reference/application#ciopjobmaxtasks>` to one instance since the streaming executable has to process all inputs at once 
