...
These files are all available in the Sandbox Hadoop distributed filesystem and the output of the ciop-run execution provides the URLs to explore this filesystem. 
